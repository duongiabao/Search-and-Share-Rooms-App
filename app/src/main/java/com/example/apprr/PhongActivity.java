...
public class PhongActivity extends AppCompatActivity {
    ...
    private void LoadMoreData() {
        ...
        listviewP.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("thongtinphong",arrP.get(position));
                startActivity(intent);
            }
        });
        //su kien keo
        listviewP.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, link, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response != null && response.length() != 2){
                    listviewP.removeFooterView(footerView);
                    try {
                        ...
                        for (int i = 0; i <jsonArray.length();i++){
                            ...
                            arrP.add(new phongXT(Id,home_name,home_price,home_person,home_phone,home_describe,locate_id,home_img,idPhong));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("style_id", String.valueOf(idP));
                return params;
            }
        };
    ...
    private void ActionToolBar() {
        ...
        toolbarP.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getIdloaiP() {
        idP = getIntent().getIntExtra("idloaiPhong",-1 );
        Log.d("giatriloaiphong",idP+"");

    }

    private void Anhxa() {
        toolbarP = (Toolbar) findViewById(R.id.toolBarPhong);
        listviewP = (ListView) findViewById(R.id.listViewPhong);
        arrP = new ArrayList<>();
        phongadapter = new phongAdapter(getApplicationContext(),arrP);
        listviewP.setAdapter(phongadapter);
        //gan layout
    ...
    public  class mHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what){
                case 0:
                    listviewP.addFooterView(footerView);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
